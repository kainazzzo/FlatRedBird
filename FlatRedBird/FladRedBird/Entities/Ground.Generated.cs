...
{
	public partial class Ground : PositionedObject, IDestroyable
	{
        ...
        public Ground(string contentManagerName, bool addToManagers) :
			base()
		{
			// Don't delete this:
		...
		public static void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("GroundStaticUnload", UnloadStaticContent);
